...
Here you have SLAPP **v2.0 build 20171113** (in the [SLAPP repository](http://terna.to.it/slapp_dep/) you have a lot of related material and a large set of old versions).
